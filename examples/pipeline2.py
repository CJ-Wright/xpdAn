...
def detector_calibration_hfi(): pass
...
t = {
    ...
    'calibration': (detector_calibration_hfi, 'raw'),
    'polarization_corrected': (
        polarization_correction_hfi, 'calibration', 'dark_corrected'),
    # 'mask': (spoof_mask_hfi, 'raw_no_fs'),
    'mask': (master_mask_hfi, 'polarization_corrected'),
...
dot_graph(t, 'xpd_pipeline_feb7', format='jpeg',
          # size="10, 10"
          # rankdir='LR'
          )
